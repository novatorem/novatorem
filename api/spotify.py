...
SPOTIFY_CLIENT_ID = 'c5946285bbb945da8889f723534d04e2'
SPOTIFY_SECRET_ID = 'd5a0a0d0b9b5428ea419dfba62e84b33'
SPOTIFY_REFRESH_TOKEN = 'AQCotw8-UUq2wgokPB_h7vz9zZ_j17Sc_hyfbeKhxK2VF2qPE3etdtnS6T8IIO4rXIIuGdT6JZFGRVyogMIiRd0hM3PQ8-HvfIRJd75VVmzZAlIJNvkn_FBH4FuFsXOPpR8'
SPOTIFY_TOKEN = ""
...
def makeSVG(data, background_color, border_color):
    ...
    if not 'currently_playing_type' in data or data["currently_playing_type"] == "track":
        ...
        artistURI = item["artists"][0]["external_urls"].get("spotify", "")
