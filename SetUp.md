...
You can add the spotify logo by removing the comment tags `<!--` and `-->` from the [code](https://github.com/novatorem/novatorem/blob/master/api/templates/spotify.html.j2#L143-L145), seen below:
```html
